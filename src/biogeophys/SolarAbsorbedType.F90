module SolarAbsorbedType
  ...
  type, public :: solarabs_type
     ...
     real(r8), pointer :: sdir_shadewall_t_lun   (:,:) ! lun direct  solar absorbed by pervious road per unit ground area per unit incident flux
     real(r8), pointer :: sdir_shaderoof_t_lun   (:,:) ! lun diffuse solar absorbed by pervious road per unit ground area per unit incident flux
     real(r8), pointer :: sdir_ar_tree_t_lun   (:,:) ! lun diffuse solar absorbed by pervious road per unit ground area per unit incident flux
     real(r8), pointer :: sdir_br_tree_t_lun   (:,:) ! lun diffuse solar absorbed by pervious road per unit ground area per unit incident flux
     ...
     real(r8), pointer :: sabs_shaderoof_dir_t_lun       (:,:) ! lun direct solar absorbed by roof per unit ground area per unit incident flux
     real(r8), pointer :: sabs_shaderoof_dif_t_lun       (:,:) ! lun diffuse solar absorbed by roof per unit ground area per unit incident flux
     real(r8), pointer :: sabs_sunwall_dir_t_lun    (:,:) ! lun direct solar absorbed by sunwall per unit wall area per unit incident flux
     real(r8), pointer :: sabs_sunwall_dif_t_lun    (:,:) ! lun diffuse solar absorbed by sunwall per unit wall area per unit incident flux
     real(r8), pointer :: sabs_shadewall_dir_t_lun  (:,:) ! lun direct solar absorbed by shadewall per unit wall area per unit incident flux
     real(r8), pointer :: sabs_shadewall_dif_t_lun  (:,:) ! lun diffuse solar absorbed by shadewall per unit wall area per unit incident flux
     real(r8), pointer :: sabs_improad_dir_t_lun    (:,:) ! lun direct solar absorbed by impervious road per unit ground area per unit incident flux
     real(r8), pointer :: sabs_improad_dif_t_lun    (:,:) ! lun diffuse solar absorbed by impervious road per unit ground area per unit incident flux
     real(r8), pointer :: sabs_perroad_dir_t_lun    (:,:) ! lun direct solar absorbed by pervious road per unit ground area per unit incident flux
     real(r8), pointer :: sabs_perroad_dif_t_lun    (:,:) ! lun diffuse solar absorbed by pervious road per unit ground area per unit incident flux
     real(r8), pointer :: sabs_br_tree_dir_t_lun      (:,:) ! lun direct solar absorbed by below-roof treeetation per unit treeetation area per unit incident flux
     real(r8), pointer :: sabs_br_tree_dif_t_lun      (:,:) ! lun diffuse solar absorbed by below-roof treeetation per unit treeetation area per unit incident flux
     real(r8), pointer :: sabs_ar_tree_dir_t_lun      (:,:) ! lun direct solar absorbed by above-roof treeetation per unit treeetation area per unit incident flux
     real(r8), pointer :: sabs_ar_tree_dif_t_lun      (:,:) ! lun diffuse solar absorbed by above-roof treeetation per unit treeetation area per unit incident flux
     real(r8), pointer :: sabs_canyon_dir_t_lun   (:,:) ! lun direct solar absorbed by impervious road per unit ground area per unit incident flux
     real(r8), pointer :: sabs_canyon_dif_t_lun   (:,:) ! lun diffuse solar absorbed by impervious road per unit ground area per unit incident flux
     real(r8), pointer :: sref_shaderoof_dir_t_lun  (:,:) ! lun direct solar reflected by roof per unit ground area per unit incident flux
     real(r8), pointer :: sref_shaderoof_dif_t_lun  (:,:) ! lun diffuse solar reflected by roof per unit ground area per unit incident flux
     real(r8), pointer :: sref_sunwall_dir_t_lun    (:,:) ! lun diffuse solar reflected by sunwall per unit wall area per unit incident flux
     real(r8), pointer :: sref_sunwall_dif_t_lun    (:,:) ! lun diffuse solar reflected by sunwall per unit wall area per unit incident flux
     real(r8), pointer :: sref_shadewall_dir_t_lun  (:,:) ! lun direct solar reflected by shadewall per unit wall area per unit incident flux
     real(r8), pointer :: sref_shadewall_dif_t_lun  (:,:) ! lun diffuse solar reflected by shadewall per unit wall area per unit incident flux
     real(r8), pointer :: sref_improad_dir_t_lun    (:,:) ! lun direct solar reflected by impervious road per unit ground area per unit incident flux
     real(r8), pointer :: sref_improad_dif_t_lun    (:,:) ! lun diffuse solar reflected by impervious road per unit ground area per unit incident flux
     real(r8), pointer :: sref_perroad_dir_t_lun    (:,:) ! lun direct solar reflected by pervious road per unit ground area per unit incident flux
     real(r8), pointer :: sref_perroad_dif_t_lun    (:,:) ! lun diffuse solar reflected by pervious road per unit ground area per unit incident flux
     real(r8), pointer :: sref_br_tree_dir_t_lun    (:,:) ! lun direct solar reflected by below-roof tree per unit ground area per unit incident flux
     real(r8), pointer :: sref_br_tree_dif_t_lun    (:,:) ! lun diffuse solar reflected by below-roof tree per unit ground area per unit incident flux
     real(r8), pointer :: sref_ar_tree_dir_t_lun    (:,:) ! lun direct solar reflected by above-roof tree per unit ground area per unit incident flux
     real(r8), pointer :: sref_ar_tree_dif_t_lun    (:,:) ! lun diffuse solar reflected by above-roof tree per unit ground area per unit incident flux
     real(r8), pointer :: sref_canyon_dir_t_lun     (:,:) ! lun direct solar reflected by canyon per unit ground area per unit incident flux
     real(r8), pointer :: sref_canyon_dif_t_lun     (:,:) ! lun diffuse solar reflected by canyon per unit ground area per unit incident flux

     real(r8), pointer :: lwnet_shaderoof_t_lun   (:) ! lun net longwave flux at shaded roof
     real(r8), pointer :: lwnet_improad_t_lun     (:) ! lun net longwave flux at impervious road
     real(r8), pointer :: lwnet_perroad_t_lun     (:) ! lun net longwave flux at pervious road
     real(r8), pointer :: lwnet_sunwall_t_lun     (:) ! lun net longwave flux at sunlit wall
     real(r8), pointer :: lwnet_shadewall_t_lun   (:) ! lun net longwave flux at shaded wall
     real(r8), pointer :: lwnet_br_tree_t_lun     (:) ! lun net longwave flux at below-roof tree
     real(r8), pointer :: lwnet_ar_tree_t_lun     (:) ! lun net longwave flux at above-roof tree
     real(r8), pointer :: lwnet_canyon_t_lun      (:) ! lun net longwave flux at canyon center
     real(r8), pointer :: lwup_shaderoof_t_lun    (:) ! lun upward longwave flux at shaded roof
     real(r8), pointer :: lwup_improad_t_lun      (:) ! lun upward longwave flux at impervious road
     real(r8), pointer :: lwup_perroad_t_lun      (:) ! lun upward longwave flux at pervious road
     real(r8), pointer :: lwup_sunwall_t_lun      (:) ! lun upward longwave flux at sunlit wall
     real(r8), pointer :: lwup_shadewall_t_lun    (:) ! lun upward longwave flux at shaded wall
     real(r8), pointer :: lwup_br_tree_t_lun      (:) ! lun upward longwave flux at below-roof tree
     real(r8), pointer :: lwup_ar_tree_t_lun      (:) ! lun upward longwave flux at above-roof tree
     real(r8), pointer :: lwup_canyon_t_lun       (:) ! lun upward longwave flux at canyon center
...
contains
  ...
  subroutine InitAllocate(this, bounds)
    ...
    allocate(this%sdir_shaderoof_t_lun (begl:endl,1:numrad))     ; this%sdir_shaderoof_t_lun (:,:) = nan
    allocate(this%sdir_br_tree_t_lun (begl:endl,1:numrad))     ; this%sdir_br_tree_t_lun (:,:) = nan
    allocate(this%sdir_ar_tree_t_lun (begl:endl,1:numrad))     ; this%sdir_ar_tree_t_lun (:,:) = nan
    ...
    allocate(this%sabs_shaderoof_dir_t_lun(begl:endl,1:numrad))         ; this%sabs_shaderoof_dir_t_lun(:,:) = nan
    allocate(this%sabs_shaderoof_dif_t_lun(begl:endl,1:numrad))         ; this%sabs_shaderoof_dif_t_lun(:,:) = nan
    allocate(this%sabs_sunwall_dir_t_lun(begl:endl,1:numrad))      ; this%sabs_sunwall_dir_t_lun(:,:) = nan
    allocate(this%sabs_sunwall_dif_t_lun(begl:endl,1:numrad))      ; this%sabs_sunwall_dif_t_lun(:,:) = nan
    allocate(this%sabs_shadewall_dir_t_lun(begl:endl,1:numrad))    ; this%sabs_shadewall_dir_t_lun(:,:) = nan
    allocate(this%sabs_shadewall_dif_t_lun(begl:endl,1:numrad))    ; this%sabs_shadewall_dif_t_lun(:,:) = nan
    allocate(this%sabs_improad_dir_t_lun(begl:endl,1:numrad))      ; this%sabs_improad_dir_t_lun(:,:) = nan
    ...
    allocate(this%sabs_ar_tree_dif_t_lun(begl:endl,1:numrad))        ; this%sabs_ar_tree_dif_t_lun(:,:) = nan
    allocate(this%sabs_canyon_dir_t_lun(begl:endl,1:numrad))     ; this%sabs_canyon_dir_t_lun(:,:) = nan
    allocate(this%sabs_canyon_dif_t_lun(begl:endl,1:numrad))     ; this%sabs_canyon_dif_t_lun(:,:) = nan
    allocate(this%sref_shaderoof_dir_t_lun(begl:endl,1:numrad))    ; this%sref_shaderoof_dir_t_lun(:,:) = nan
    allocate(this%sref_shaderoof_dif_t_lun(begl:endl,1:numrad))    ; this%sref_shaderoof_dif_t_lun(:,:) = nan
    allocate(this%sref_sunwall_dir_t_lun(begl:endl,1:numrad))      ; this%sref_sunwall_dir_t_lun(:,:) = nan
    allocate(this%sref_sunwall_dif_t_lun(begl:endl,1:numrad))      ; this%sref_sunwall_dif_t_lun(:,:) = nan
    allocate(this%sref_shadewall_dir_t_lun(begl:endl,1:numrad))    ; this%sref_shadewall_dir_t_lun(:,:) = nan
    allocate(this%sref_shadewall_dif_t_lun(begl:endl,1:numrad))    ; this%sref_shadewall_dif_t_lun(:,:) = nan
    allocate(this%sref_improad_dir_t_lun(begl:endl,1:numrad))      ; this%sref_improad_dir_t_lun(:,:) = nan
    ...
    allocate(this%sref_ar_tree_dif_t_lun(begl:endl,1:numrad))      ; this%sref_ar_tree_dif_t_lun(:,:) = nan
    allocate(this%sref_canyon_dir_t_lun(begl:endl,1:numrad))       ; this%sref_canyon_dir_t_lun(:,:) = nan
    allocate(this%sref_canyon_dif_t_lun(begl:endl,1:numrad))       ; this%sref_canyon_dif_t_lun(:,:) = nan
    ...
    allocate(this%lwnet_ar_tree_t_lun(begl:endl))         ; this%lwnet_ar_tree_t_lun(:) = nan
    allocate(this%lwnet_canyon_t_lun(begl:endl))          ; this%lwnet_canyon_t_lun(:) = nan
    allocate(this%lwup_shaderoof_t_lun(begl:endl))        ; this%lwup_shaderoof_t_lun(:) = nan
    allocate(this%lwup_improad_t_lun(begl:endl))          ; this%lwup_improad_t_lun(:) = nan
    allocate(this%lwup_perroad_t_lun(begl:endl))          ; this%lwup_perroad_t_lun(:) = nan
    allocate(this%lwup_sunwall_t_lun(begl:endl))          ; this%lwup_sunwall_t_lun(:) = nan
    allocate(this%lwup_shadewall_t_lun(begl:endl))        ; this%lwup_shadewall_t_lun(:) = nan
    allocate(this%lwup_br_tree_t_lun(begl:endl))          ; this%lwup_br_tree_t_lun(:) = nan
    allocate(this%lwup_ar_tree_t_lun(begl:endl))          ; this%lwup_ar_tree_t_lun(:) = nan
    allocate(this%lwup_canyon_t_lun(begl:endl))           ; this%lwup_canyon_t_lun(:) = nan
  ...
  subroutine InitHistory(this, bounds)
    ...
    call hist_addfld2d (fname='SDIR_ROAD', units='unitless', type2d='numrad', &
      ...
      ptr_lunit=this%sdir_road_t_lun, set_nourb=spval, l2g_scale_type='unity', &
      default='inactive')

    this%sdir_sunwall_t_lun(begl:endl,:) = spval 
    call hist_addfld2d (fname='SDIR_SUNWALL', units='unitless', type2d='numrad', &
      ...
      ptr_lunit=this%sdir_sunwall_t_lun, set_nourb=spval, l2g_scale_type='unity', &
      default='inactive')

    this%sdir_shadewall_t_lun(begl:endl,:) = spval 
    call hist_addfld2d (fname='SDIR_SHADEWALL', units='unitless', type2d='numrad', &
      ...
      ptr_lunit=this%sdir_shadewall_t_lun, set_nourb=spval, l2g_scale_type='unity', &
      default='inactive')   
      
    this%sdir_shaderoof_t_lun(begl:endl,:) = spval 
    call hist_addfld2d (fname='SDIR_SHADEROOF', units='unitless', type2d='numrad', &
      avgflag='A', long_name='Unitless incident solar on shaded roof', &
      ptr_lunit=this%sdir_shaderoof_t_lun, set_nourb=spval, l2g_scale_type='unity', &
      default='inactive')   
           
    this%sdir_ar_tree_t_lun(begl:endl,:) = spval 
    call hist_addfld2d (fname='SDIR_AR_TREE', units='unitless', type2d='numrad', &
      ...
      ptr_lunit=this%sdir_ar_tree_t_lun, set_nourb=spval, l2g_scale_type='unity', &
      default='inactive')   

    this%sdir_br_tree_t_lun(begl:endl,:) = spval 
    call hist_addfld2d (fname='SDIR_BR_TREE', units='unitless', type2d='numrad', &
      ...
      ptr_lunit=this%sdir_br_tree_t_lun, set_nourb=spval, l2g_scale_type='unity', &
      default='inactive')   
    ...
    call hist_addfld2d (fname='SDIR_ROAD_NOTREE', units='unitless', type2d='numrad', &
     avgflag='A', long_name='Unitless incident solar on road', &
     ptr_lunit=this%sdir_road_lun, set_nourb=spval, l2g_scale_type='unity', &
     default='inactive')

    this%sdir_sunwall_lun(begl:endl,:) = spval 
    call hist_addfld2d (fname='SDIR_SUNWALL_NOTREE', units='unitless', type2d='numrad', &
     avgflag='A', long_name='Unitless incident solar on sun-lit wall', &
     ptr_lunit=this%sdir_sunwall_lun, set_nourb=spval, l2g_scale_type='unity', &
     default='inactive')
     
    this%sabs_shaderoof_dir_t_lun(begl:endl,:) = spval
    call hist_addfld2d (fname='SABS_SHADEROOF_DIR', units='unitless', type2d='numrad', &
       avgflag='A', long_name='Unitless incident direct solar absorbed by roof per unit ground area per unit incident flux', &
       ptr_lunit=this%sabs_shaderoof_dir_t_lun, set_nourb=spval, l2g_scale_type='unity', &
       default='inactive')
    this%sabs_shaderoof_dif_t_lun(begl:endl,:) = spval
    call hist_addfld2d (fname='SABS_SHADEROOF_DIF', units='unitless', type2d='numrad', &
       avgflag='A', long_name='Unitless incident diffuse solar absorbed by roof per unit ground area per unit incident flux', &
       ptr_lunit=this%sabs_shaderoof_dif_t_lun, set_nourb=spval, l2g_scale_type='unity', &
       default='inactive')
       
    this%sabs_sunwall_dir_t_lun(begl:endl,:) = spval
    call hist_addfld2d (fname='SABS_SUNWALL_DIR', units='unitless', type2d='numrad', &
       ...
       ptr_lunit=this%sabs_sunwall_dir_t_lun, set_nourb=spval, l2g_scale_type='unity', &
       default='inactive')
    this%sabs_sunwall_dif_t_lun(begl:endl,:) = spval
    call hist_addfld2d (fname='SABS_SUNWALL_DIF', units='unitless', type2d='numrad', &
       ...
       ptr_lunit=this%sabs_sunwall_dif_t_lun, set_nourb=spval, l2g_scale_type='unity', &
       default='inactive')
       
    this%sabs_shadewall_dir_t_lun(begl:endl,:) = spval
    call hist_addfld2d (fname='SABS_SHADEWALL_DIR', units='unitless', type2d='numrad', &
       ...
       ptr_lunit=this%sabs_shadewall_dir_t_lun, set_nourb=spval, l2g_scale_type='unity', &
       default='inactive')
    this%sabs_shadewall_dif_t_lun(begl:endl,:) = spval
    call hist_addfld2d (fname='SABS_SHADEWALL_DIF', units='unitless', type2d='numrad', &
       ...
       ptr_lunit=this%sabs_shadewall_dif_t_lun, set_nourb=spval, l2g_scale_type='unity', &
       default='inactive')
       
    this%sabs_improad_dir_t_lun(begl:endl,:) = spval
    call hist_addfld2d (fname='SABS_IMPROAD_DIR', units='unitless', type2d='numrad', &
       ...
       ptr_lunit=this%sabs_improad_dir_t_lun, set_nourb=spval, l2g_scale_type='unity', &
       default='inactive')
    this%sabs_improad_dif_t_lun(begl:endl,:) = spval
    call hist_addfld2d (fname='SABS_IMPROAD_DIF', units='unitless', type2d='numrad', &
       ...
       ptr_lunit=this%sabs_improad_dif_t_lun, set_nourb=spval, l2g_scale_type='unity', &
       default='inactive')
       
    this%sabs_perroad_dir_t_lun(begl:endl,:) = spval
    ...
    call hist_addfld2d (fname='SABS_BR_TREE_DIR', units='unitless', type2d='numrad', &
       ...
       ptr_lunit=this%sabs_br_tree_dir_t_lun, set_nourb=spval, l2g_scale_type='unity', &
       default='inactive')
    this%sabs_br_tree_dif_t_lun(begl:endl,:) = spval
    call hist_addfld2d (fname='SABS_BR_TREE_DIF', units='unitless', type2d='numrad', &
       ...
       ptr_lunit=this%sabs_br_tree_dif_t_lun, set_nourb=spval, l2g_scale_type='unity', &
       default='inactive')
       
    this%sabs_ar_tree_dir_t_lun(begl:endl,:) = spval
    call hist_addfld2d (fname='SABS_AR_TREE_DIR', units='unitless', type2d='numrad', &
       ...
       ptr_lunit=this%sabs_ar_tree_dir_t_lun, set_nourb=spval, l2g_scale_type='unity', &
       default='inactive')
    this%sabs_ar_tree_dif_t_lun(begl:endl,:) = spval
    call hist_addfld2d (fname='SABS_AR_TREE_DIF', units='unitless', type2d='numrad', &
       ...
       ptr_lunit=this%sabs_ar_tree_dif_t_lun, set_nourb=spval, l2g_scale_type='unity', &
       default='inactive')
       
    this%sabs_canyon_dir_t_lun(begl:endl,:) = spval
    call hist_addfld2d (fname='SABS_CANYON_DIR', units='unitless', type2d='numrad', &
       avgflag='A', long_name='Unitless incident direct solar absorbed by impervious road per unit ground area per unit incident flux', &
       ptr_lunit=this%sabs_canyon_dir_t_lun, set_nourb=spval, l2g_scale_type='unity', &
       default='inactive')
    this%sabs_canyon_dif_t_lun(begl:endl,:) = spval
    call hist_addfld2d (fname='SABS_CANYON_DIF', units='unitless', type2d='numrad', &
       avgflag='A', long_name='Unitless incident diffuse solar absorbed by impervious road per unit ground area per unit incident flux', &
       ptr_lunit=this%sabs_canyon_dif_t_lun, set_nourb=spval, l2g_scale_type='unity', &
       default='inactive')

    this%sref_shaderoof_dir_t_lun(begl:endl,:) = spval
    call hist_addfld2d (fname='SREF_SHADEROOF_DIR', units='unitless', type2d='numrad', &
       avgflag='A', long_name='Unitless incident shaderoof direct solar flux lun', &
       ptr_lunit=this%sref_shaderoof_dir_t_lun, set_nourb=spval, l2g_scale_type='unity', &
       default='inactive')
    this%sref_shaderoof_dif_t_lun(begl:endl,:) = spval
    call hist_addfld2d (fname='SREF_SHADEROOF_DIF', units='unitless', type2d='numrad', &
       avgflag='A', long_name='Unitless incident shaderoof diffuse solar flux lun', &
       ptr_lunit=this%sref_shaderoof_dif_t_lun, set_nourb=spval, l2g_scale_type='unity', &
       default='inactive')
       
    this%sref_sunwall_dir_t_lun(begl:endl,:) = spval
    call hist_addfld2d (fname='SREF_SUNWALL_DIR', units='unitless', type2d='numrad', &
       ...
       ptr_lunit=this%sref_sunwall_dir_t_lun, set_nourb=spval, l2g_scale_type='unity', &
       default='inactive')       
    this%sref_sunwall_dif_t_lun(begl:endl,:) = spval
    call hist_addfld2d (fname='SREF_SUNWALL_DIF', units='unitless', type2d='numrad', &
       ...
       ptr_lunit=this%sref_sunwall_dif_t_lun, set_nourb=spval, l2g_scale_type='unity', &
       default='inactive')
       
    this%sref_shadewall_dir_t_lun(begl:endl,:) = spval
    call hist_addfld2d (fname='SREF_SHADEWALL_DIR', units='unitless', type2d='numrad', &
       ...
       ptr_lunit=this%sref_shadewall_dir_t_lun, set_nourb=spval, l2g_scale_type='unity', &
       default='inactive')
    this%sref_shadewall_dif_t_lun(begl:endl,:) = spval
    call hist_addfld2d (fname='SREF_SHADEWALL_DIF', units='unitless', type2d='numrad', &
       ...
       ptr_lunit=this%sref_shadewall_dif_t_lun, set_nourb=spval, l2g_scale_type='unity', &
       default='inactive')
       
    this%sref_improad_dir_t_lun(begl:endl,:) = spval
    call hist_addfld2d (fname='SREF_IMPROAD_DIR', units='unitless', type2d='numrad', &
       ...
       ptr_lunit=this%sref_improad_dir_t_lun, set_nourb=spval, l2g_scale_type='unity', &
       default='inactive')
    this%sref_improad_dif_t_lun(begl:endl,:) = spval
    call hist_addfld2d (fname='SREF_IMPROAD_DIF', units='unitless', type2d='numrad', &
       ...
       ptr_lunit=this%sref_improad_dif_t_lun, set_nourb=spval, l2g_scale_type='unity', &
       default='inactive')
       
    this%sref_perroad_dir_t_lun(begl:endl,:) = spval
    call hist_addfld2d (fname='SREF_PERROAD_DIR', units='unitless', type2d='numrad', &
       ...
       ptr_lunit=this%sref_perroad_dir_t_lun, set_nourb=spval, l2g_scale_type='unity', &
       default='inactive')
    this%sref_perroad_dif_t_lun(begl:endl,:) = spval
    ...
    call hist_addfld2d (fname='SREF_AR_TREE_DIR', units='unitless', type2d='numrad', &
       avgflag='A', long_name='Unitless incident arree direct solar flux lun', &
       ptr_lunit=this%sref_ar_tree_dir_t_lun, set_nourb=spval, l2g_scale_type='unity', &
       default='inactive')
    this%sref_ar_tree_dif_t_lun(begl:endl,:) = spval
    call hist_addfld2d (fname='SREF_AR_TREE_DIF', units='unitless', type2d='numrad', &
       avgflag='A', long_name='Unitless incident arree diffuse solar flux lun', &
       ptr_lunit=this%sref_ar_tree_dif_t_lun, set_nourb=spval, l2g_scale_type='unity', &
       default='inactive')
       
    this%sref_canyon_dir_t_lun(begl:endl,:) = spval
    call hist_addfld2d (fname='SREF_CANYON_DIR', units='unitless', type2d='numrad', &
       ...
       ptr_lunit=this%sref_canyon_dir_t_lun, set_nourb=spval, l2g_scale_type='unity', &
       default='inactive')
    this%sref_canyon_dif_t_lun(begl:endl,:) = spval
    call hist_addfld2d (fname='SREF_CANYON_DIF', units='unitless', type2d='numrad', &
       ...
       ptr_lunit=this%sref_canyon_dif_t_lun, set_nourb=spval, l2g_scale_type='unity', &
       default='inactive')

    this%lwnet_shaderoof_t_lun(begl:endl) = spval
    call hist_addfld1d (fname='LWNET_SHADEROOF', units='unitless', &
      avgflag='A', long_name='Unitless incident net longwave flux at shaded roof', &
      ptr_lunit=this%lwnet_shaderoof_t_lun, set_nourb=spval, l2g_scale_type='unity', &
      default='inactive')
    this%lwnet_improad_t_lun(begl:endl) = spval
    ...
    call hist_addfld1d (fname='LWNET_SUNWALL', units='unitless', &
      ...
      ptr_lunit=this%lwnet_sunwall_t_lun, set_nourb=spval, l2g_scale_type='unity', &
      default='inactive')
    this%lwnet_shadewall_t_lun(begl:endl) = spval
    call hist_addfld1d (fname='LWNET_SHADEWALL', units='unitless', &
      ...
      ptr_lunit=this%lwnet_shadewall_t_lun, set_nourb=spval, l2g_scale_type='unity', &
      default='inactive')
    this%lwnet_br_tree_t_lun(begl:endl) = spval
    call hist_addfld1d (fname='LWNET_BR_TREE', units='unitless', &
      ...
      ptr_lunit=this%lwnet_br_tree_t_lun, set_nourb=spval, l2g_scale_type='unity', &
      default='inactive')
    this%lwnet_ar_tree_t_lun(begl:endl) = spval
    call hist_addfld1d (fname='LWNET_AR_TREE', units='unitless', &
      ...
      ptr_lunit=this%lwnet_ar_tree_t_lun, set_nourb=spval, l2g_scale_type='unity', &
      default='inactive')
    this%lwnet_canyon_t_lun(begl:endl) = spval
    call hist_addfld1d (fname='LWNET_CANYON', units='unitless', &
      ...
      ptr_lunit=this%lwnet_canyon_t_lun, set_nourb=spval, l2g_scale_type='unity', &
      default='inactive')
      
    this%lwup_shaderoof_t_lun(begl:endl) = spval
    call hist_addfld1d (fname='LWUP_SHADEROOF', units='unitless', &
      avgflag='A', long_name='Unitless incident upward longwave flux at shaded roof', &
      ptr_lunit=this%lwup_shaderoof_t_lun, set_nourb=spval, l2g_scale_type='unity', &
      default='inactive')
    this%lwup_improad_t_lun(begl:endl) = spval
    call hist_addfld1d (fname='LWUP_IMPROAD', units='unitless', &
      ...
      ptr_lunit=this%lwup_improad_t_lun, set_nourb=spval, l2g_scale_type='unity', &
      default='inactive')
    this%lwup_perroad_t_lun(begl:endl) = spval
    call hist_addfld1d (fname='LWUP_PERROAD', units='unitless', &
      ...
      ptr_lunit=this%lwup_perroad_t_lun, set_nourb=spval, l2g_scale_type='unity', &
      default='inactive')
    this%lwup_sunwall_t_lun(begl:endl) = spval
    call hist_addfld1d (fname='LWUP_SUNWALL', units='unitless', &
      ...
      ptr_lunit=this%lwup_sunwall_t_lun, set_nourb=spval, l2g_scale_type='unity', &
      default='inactive')
    this%lwup_shadewall_t_lun(begl:endl) = spval
    call hist_addfld1d (fname='LWUP_SHADEWALL', units='unitless', &
      ...
      ptr_lunit=this%lwup_shadewall_t_lun, set_nourb=spval, l2g_scale_type='unity', &
      default='inactive')
    this%lwup_br_tree_t_lun(begl:endl) = spval
    call hist_addfld1d (fname='LWUP_BR_TREE', units='unitless', &
      ...
      ptr_lunit=this%lwup_br_tree_t_lun, set_nourb=spval, l2g_scale_type='unity', &
      default='inactive')
    this%lwup_ar_tree_t_lun(begl:endl) = spval
    call hist_addfld1d (fname='LWUP_AR_TREE', units='unitless', &
      ...
      ptr_lunit=this%lwup_ar_tree_t_lun, set_nourb=spval, l2g_scale_type='unity', &
      default='inactive')
    this%lwup_canyon_t_lun(begl:endl) = spval
    call hist_addfld1d (fname='LWUP_CANYON', units='unitless', &
      ...
      ptr_lunit=this%lwup_canyon_t_lun, set_nourb=spval, l2g_scale_type='unity', &
      default='inactive')
